...
//Alerta para las variables a buscar
    //alert(datos);
    //alert(dato);
    //alert(dato2);
...
function llenarTabla()
{
    ...
    for(let i=0; i <osOrd.length; i++){
        ...
        `<tr>
                ...
                <td>${osOrd[i][0].Solicitud}</td>
                <td>${osOrd[i][0].fecIni}</td>
                <td>${osOrd[i][0].fecFin}</td>
...
*/
	...
	CodEmpleado = document.getElementById('CodEmpleados').value;
	
	console.log("Empleado a agregar ---->",CodEmpleado);
    axios({
        method:'Post',
...
function llenarTablaPres()
{
    ...
    for(let i=0; i <osOrd.length; i++){
        ...
        `<tr>
                <td>${osOrd[i][0].CodEmpleado}</td>
                <td>${osOrd[i][0].Fecha_Solicitud}</td>
                <td>${osOrd[i][0].Nombre}</td>
